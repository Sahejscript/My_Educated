                ...
                <ul class="main-menu__list">
                    ...
                    <li class="dropdown">
                        ...
                        <ul>
                            ...
                            <li><a href="course-carousel.html">Web Development</a></li>
                            <li><a href="management-consulting.html">Video Editing</a></li>
                            <li><a href="web-development.html">Artificial Intelligence</a></li>
                            <li><a href="frontend-development.html">Data Science</a></li>
                            <li><a href="uiux-design.html">Graphic Designing</a></li>
             ...
             <div class="main-menu__right">
                ...
                <a href="login.html" class="main-menu__login">
                    {{-- <i class="icon-account-1"></i> --}}
                     <a href="contact.html" class="eduact-btn"><span class="eduact-btn__curve"></span>Login</a><!-- /.contact btn -->
                 </a><!-- /.login btn -->
                <a href="{{ route('register')}}" class="eduact-btn"><span class="eduact-btn__curve"></span>Register</a><!-- /.contact btn -->
