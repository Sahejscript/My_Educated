...
@section('content')
                ...
                <div class="col-lg-6">
                    <div class="hero-banner__content">
                        ...
                        <div class="hero-banner__btn wow fadeInUp" data-wow-delay="600ms">
                            <a href="contact.html" class="eduact-btn eduact-btn-second"><span class="eduact-btn__curve"></span>Register Now<i class="icon-arrow"></i></a>
    ...
    <section class="service-one">
        <div class="service-one__bg" style="background-image: url(assets/images/shapes/service-bg-1-dark.png);"></div>
        <div class="container">
            <div class="row">
    ...
    <!-- About End -->
    <!-- Category Start -->
    <section class="category-one" style="background-image: url(assets/images/shapes/category-bg-1-dark.jpg);">
        <div class="container">
    ...
    <!-- Category End -->
    <!-- Course Start -->
    <section class="course-one" style="background-image: url(assets/images/shapes/course-bg-1-dark.png);">
        <div class="container">
            <div class="section-title text-center">
                <h5 class="section-title__tagline">
                    Best Course
    ...
    <!-- Counter Start -->
    <section class="counter-one" style="background-image: url(assets/images/shapes/counter-bg-1-dark.jpg);">
        <div class="container">
            <div class="row">
    ...
    <!-- Testimonial End -->
    <!-- Team Start -->
    <section class="team-one" style="background-image: url(assets/images/shapes/team-bg-1-dark.png);">
        <div class="container">
